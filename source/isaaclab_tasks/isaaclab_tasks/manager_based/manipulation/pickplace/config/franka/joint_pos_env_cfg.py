...
from isaaclab_tasks.manager_based.manipulation.pickplace.config.franka.pickplace_env_cfg import PickPlaceEnvCfg
...
class FrankaCubePickPlaceEnvCfg(PickPlaceEnvCfg):
    def __post_init__(self):
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/Robot/panda_link0", # CHANGE whole joint set root position
            debug_vis=True,
...
@configclass
class FrankaCubePickPlaceEnvCfg_PLAY(FrankaCubePickPlaceEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
