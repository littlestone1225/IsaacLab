...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.22, 0, 0], rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(
...
class CommandsCfg:
    ...
    object_pose = mdp.UniformPoseCommandCfg(
        ...
        resampling_time_range=(5.0, 5.0), #CHANGE
        debug_vis=True,
...
class ActionsCfg:
    ...
    jaw_action: mdp.BinaryJointPositionActionCfg = MISSING
    #jaw_action: mdp.JointPositionActionCfg | mdp.DifferentialInverseKinematicsActionCfg = MISSING
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        jaw_pos = ObsTerm(func=mdp.jaw_pos)
    ...
    class SubtaskCfg(ObsGroup):
        ...
        is_grasped = ObsTerm(func=mdp.object_grasped_soarm100,
                             params={"robot_cfg": SceneEntityCfg("robot"), 
                                     "ee_frame_cfg": SceneEntityCfg("ee_frame"),
                                     "object_cfg": SceneEntityCfg("upper_cube"),
                                     "gripper_open_val": 1.0,})
        is_stacked = ObsTerm(func=mdp.object_stacked_soarm100,
                             params={"robot_cfg": SceneEntityCfg("robot"), 
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.0, 0.1), "y": (-0.1, 0.1), "z": (0.0, 0.0)}, # for soarm100 
            "velocity_range": {},
...
class RewardsCfg:
    ...
    reaching_object = RewTerm(
        func=mdp.reach_upper_cube_reward_soarm100, 
        params={"std": 0.1,
                "ee_frame_cfg": SceneEntityCfg("ee_frame"), 
    ...
    objects_distance = RewTerm(
        ...
        params={"std": 0.3,
                "minimal_height": 0.02, # desktop height
                "object1_cfg": SceneEntityCfg("upper_cube"),
                "object2_cfg": SceneEntityCfg("lower_cube"),}, 
        weight=10.0)
    ...
    released_object = RewTerm(
        func=mdp.release_upper_cube_reward_soarm100,
        params={"std": 0.3,
                "minimal_height": 0.02,
                "dis_threshold": 0.03,
...
class CurriculumCfg:
    ...
    released_object = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "released_object", "weight": 50, "num_steps": 60000}
    )
...
class PickPlaceEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=4096, env_spacing=1)
    # Basic settings
